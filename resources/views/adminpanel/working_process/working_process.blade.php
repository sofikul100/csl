...
@section('content')
    ...
    @endif --}}
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Working Process/ <a href="">List</a></h4>
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('working_process.add.form') }}" class="text-white bg-primary btn btn-sm">Add New</a>
                    </div>
                    <div class="card-body">
                        <div class="card">
                            <div class="table-responsive text-nowrap">
                                <table class="table" id="dTable">
                                    ...
                                    <tbody class="">
                                        @foreach ($working_process as $key => $item)
                                            <tr>
                                                <td>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="d-inline-flex align-items-center gap-1">
                                                            <a class="text-white btn-info btn-sm btn"
                                                                href="{{ route('working_process.edit', $item->id) }}"><i
                                                                    class="bx bx-edit-alt "></i></a>
                                                            <form action="{{ route('working_process.delete', $item->id) }}"
                                                                method="POST">
                                                                @csrf
